    ...
    <AuthLayout navigation={props.navigation} style={styles().justifyCenter}>
        ...
        <View style={[styles().alignCenter]}>
            ...
            <View style={[styles().mt25, styles().mb15]}>
                <Text style={[styles().fs20, styles().fontRegular, {color:currentTheme.black}]}>Let's Create Your </Text>
                <Text style={[styles().fs20, styles().textCenter, styles().fontSemibold, styles().lh30, styles().fw600, {color:currentTheme.themeBackground}]}>Profile</Text>
            </View>
        </View>

            
                <ThemeButton Title={"Let's Begin"} 
