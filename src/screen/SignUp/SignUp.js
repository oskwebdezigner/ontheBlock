...
export default function Signup(props) {
  ...
  function validation() {
    ...
    const lastNameErr = validateFunc(
      lastname ? { lastname } : null,
      "lastname"
    );
    const numberErr = validateFunc(
      number ? { mobile: number } : null,
      "mobile"
    );
    ...
    const referralIdErr = validateFunc(
  ...
  const [mutate, { client }] = useMutation(CREATE_USER, {
    onCompleted,
    onError,
  });
      ...
      >
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          >
            ...
            >
              I agree to use{" "}
              <Text style={styles().textDecorationUnderline}>
                Usage and Terms
              </Text>{" "}
              and{" "}
              <Text style={styles().textDecorationUnderline}>
