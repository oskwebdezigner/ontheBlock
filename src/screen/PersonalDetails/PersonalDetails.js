...
import {  Platform, Button, Animated, Dimensions, FlatList, Text, TouchableOpacity, View ,Image, KeyboardAvoidingView } from 'react-native';
...
export default function PersonalDetails(props){
  ...
  const [defautDob, setdefautDob] = useState(NewformatDate(new Date()).toString());
...
return( 
    <Layout navigation={props.navigation} LeftIcon={true} withoutScroll={true} pagetitle={'Personal Details'} homeGrad={true} ProfileImg={false} >
    ...
    <View style={[styles().mt5]}>
        <PhoneInput ref={ref} initialCountry={'us'}
            style={[
                styles().h60px,
                styles().pl15,
    ...
    <View style={styles().mt5}>
         ...
         <Multiselect ListItems={NationalityList} SelectText={'Nationality'} value={Nationality} setValue={SetNationality}/>
    </View>
    <View style={styles().mt5}>
        
        <Multiselect ListItems={NationalityList} SelectText={'Country of Residence'} value={Residence} setValue={SetResidence}/>
    </View>
    <View style={styles().mt5}>
        {/* <TextField
            keyboardType='default'
        ...
        /> */}
        <View style={[styles().h60px, styles(currentTheme).bgWhite, styles().ph20, styles().justifyCenter, styles().br10]}>
    ...
    <View style={[styles().flexRow, styles().mt20, styles().justifyEnd]}>
      <ThemeButton Title={'Update'} onPress={()=> props.navigation.navigate('Profile')}
