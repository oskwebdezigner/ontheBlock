    ...
    renderItem={({ item , index }) => {
        ...
        return (
            ...
            style={[styles().ph15, styles().pt15, styles().pb20, styles().bw1, styles().br10, styles(currentTheme).bgWhite, styles().mb20, {borderColor:currentTheme.closingPrizeBd}]}>
                ...
                <View>
                    <Text style={[styles().fs14, styles().fontBold, styles().fw700, {color:currentTheme.black}]}>{item.amount} Cash</Text>
                    <Text style={[styles().fs14, styles().fontBold, styles().fw700, {color:currentTheme.textColor}]}>{item.sku}</Text>
                    <Text style={[styles().fs14, styles().mt5, styles().mb10, styles().fontBold, styles().fw700, {color:currentTheme.themeBackground}]}>{item.SoldDate}</Text>
                    
                    <ThemeButton Title={'You are not a participant in this.'} Style={[styles().fs10, styles().h40px]} withoutBg={true} />
                </View>
            </TouchableOpacity>
